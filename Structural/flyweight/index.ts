...
class Terrorist implements Player {
  ...
  public mission() {
    console.log("Terrorist with weapon " + this.weapon + "|" + " Task is " + this.task);
  }
} 
...
class CounterTerrorist implements Player {
  ...
  public mission() {
    console.log("Counter Terrorist with weapon " + this.weapon + "|" + " Task is " + this.task);
  }
}
...
class CounterStrike  {
  ...
  private static weapons: string[] =  ["AK-47", "Maverick", "Gut Knife", "Desert Eagle"];
  ...
  public static getRandPlayerType(): string {
    const randInt: number = Math.floor(Math.random() * this.playerType.length);
